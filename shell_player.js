...
window.ShellPlayer = (function(){
  ...
  var cur       = -1;
  var mode      = 'music'; // 'music' | 'audiobook'
  ...
  function init(){
    ...
    if(el){
      ...
      el.addEventListener('pause', function(){ setPlayIcons(false); });
      el.addEventListener('play',  function(){ setPlayIcons(true);  });
    }
