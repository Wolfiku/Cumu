...
$b=BASE_URL;
?>
<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Cumu – Sign In</title><link rel="stylesheet" href="<?=$b?>/style.css"></head>
<body class="auth-page"><div class="auth-card">
  ...
  <form method="POST" action="<?=$b?>/backend/login.php">
    <div class="form-group"><label>Username</label><input type="text" name="username" required autofocus autocomplete="username"></div>
